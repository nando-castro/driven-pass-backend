...
function createCard(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const card = req.body;
        yield cardService.createCard(card, token);
...
function removeCard(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { token } = res.locals;
        const { id } = req.params;
        yield cardService.removeCard(Number(id), token);
...
function getCard(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { token } = res.locals;
        const { id } = req.params;
        const result = yield cardService.getCard(Number(id), token);
...
function getAllCards(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { token } = res.locals;
        const result = yield cardService.getAllCards(token);
        res.status(200).send(result);
    });
}
